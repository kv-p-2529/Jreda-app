...
function FlagIN() {
  return (
    ...
    >
      ...
      >
        <View
          style={{ width: 5, height: 5, borderRadius: 3, borderWidth: 1, borderColor: '#0A3DA6' }}
        />
      </View>
...
export default function LoginScreen({
  ...
  return (
    <View className="rounded-[22px] p-2 relative">
      {/* Floating Icon */}
      ...
      <IconInput
        ...
        icon={
          <TouchableOpacity className="flex-row items-center" activeOpacity={0.7}>
            <FlagIN />
            <Text className="ml-2 text-[16px] text-[#1A1A1A] font-medium">
              +91
            </Text>
            <Ionicons
              name="chevron-down"
      ...
      <TouchableOpacity onPress={goToRegister}>
        <Text className="text-[#00aeff] text-[18px] font-semibold text-center mt-4">
          New here ? Register
        </Text>
      </TouchableOpacity>
    </View>
